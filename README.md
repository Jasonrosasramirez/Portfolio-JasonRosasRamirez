...
2. [GitHub Profile](#updated-github-profile)    -- (mostly done) -- + -- 
...
1. Professional profile picture -- (Check) --
...
3. Your current location -- (Check) --

4. Email address -- (Check) --

5. Link to your deployed portfolio

6. At least 2 pinned repositories: -- (Check) --
...
7. Follow a few of your classmates. They are the beginning of your professional network and being a developer is as much about being a part of the community as it is writing code. -- (Check) -- 
...
9. Commit history. Every pinned repository should have at least 20 commits. -- (Check) --

### 3. Updated Resume -- (Check) --

💁 Need help building a resume? Check out the [Career Services milestone resources](https://mycareerspot.org/resume). -- (Check) --

Submit a clear, concise, and compelling resume, tailored to the type of job you’re looking for.

Your resume should include:

* a heading with your name, phone number, professional email address, links to LinkedIn, portfolio and GitHub -- (Check) --

* a technical skills section, with all programming languages and technologies listed -- (Check) --

* 3 of your strongest projects/homework assignments with brief description, languages used, and URL -- (Check) --
* 

### 4. Updated LinkedIn -- (Check) --

💁 Need help updating your LinkedIn? Check out the [Career Services milestone resources for online presence](https://mycareerspot.org/onlinepresence). -- (Check) --

Update your LinkedIn Profile with a strong bio statement, a professional photo, and links to your Github and portfolio. -- (Check) --


### ⭐ 5. For Job-Seeking Students (BONUS) -- (Check) --
